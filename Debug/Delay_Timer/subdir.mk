...
OBJS += \
./Delay_Timer/Delay_Timer.o 

C_DEPS += \
./Delay_Timer/Delay_Timer.d 


# Each subdirectory must supply rules for building sources it contributes
Delay_Timer/%.o Delay_Timer/%.su: ../Delay_Timer/%.c Delay_Timer/subdir.mk
...
clean: clean-Delay_Timer

clean-Delay_Timer:
	-$(RM) ./Delay_Timer/Delay_Timer.d ./Delay_Timer/Delay_Timer.o ./Delay_Timer/Delay_Timer.su

.PHONY: clean-Delay_Timer
